...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('elements', function (Blueprint $table) {
            ...
            $table->enum('work_nature', ['administrative', 'overnight', 'resident_administrative', 'field'])->nullable();
            ...
            $table->enum('education_level', ['illiterate', 'primary', 'preparatory', 'secondary', 'intermediate_institute', 'university', 'postgraduate'])->nullable();
            ...
            $table->decimal('work_lng', 10, 7)->nullable()->comment('Workplace longitude');
            $table->decimal('distance_km', 8, 2)->nullable()->comment('Residence to workplace distance in km');
            $table->timestamps();
            $table->softDeletes();
        });
    }
